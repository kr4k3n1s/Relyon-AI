...
// 3. Focus on allergy related issues, use only allergies or intolerances related to provided issues based on included sources.
// 4. Be specific! General, unrelated, non specific or not complete answers are not acceptable. Always define each possible possibility.
// 5. Follow provided structure! No other structure is acceptable.
...
Rules:
1. Do not include your thoughts, only say result that can be presented to the patient.
2. Do not make up things!!!!!, rely clearly on the sources, if there is nothing related from the source to any part of the input, do not consider this cause as a valid point in analysis and skip it.
3. Focus on allergy related issues, use only allergies or intolerances related to provided issues based on included sources.
4. Be specific! General, unrelated, non specific or not complete answers are not acceptable. 
5. Always define each possible cause or disease!
`;
